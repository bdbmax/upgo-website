...
In Canada, the percentage of people who commute to work by public transit increased from 10.1% in 1996 to 12.4% in 2016—and in Montreal and Toronto that number increases to more than 20% (Statistics Canada, 2017). Early fears that SARS-CoV-2 is partially transmitted through contact with surfaces (Dietz et al, 2020), 

The COVID-19 pandemic has had a significant impact on public transportation systems. In Wuhan, the source of the outbreak in China (Schultz, 2020), public transport was temporarily brought to a halt amid efforts to contain the spread of the virus (Xu, 2020). In late March, amid concerns about virus transmission, demand for public transport in Canada dropped by an average of 83 percent compared to previous years, and similar patterns were seen in France (CBC News, 2020) and the U.S. (Hawkins, 2020).
