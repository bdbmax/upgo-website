---
title: "UPGo 2019 year in review"
date: '2020-01-04'
type: "post"
slug: upgo-2019-year-in-review
categories: []
tags:
  - Bike sharing
  - Gentrification
  ...
  - Vancouver
subtitle: ''
summary: "A look back at an action-packed 2019, and a glimpse into the coming year"
authors:
  - admin
lastmod: '2020-01-04T07:00:06-04:00'
featured: yes
image:
  placement: 3
projects:
...
2019 has come to a close, and with 


### January: "The impact of new short-term rental regulations on New York City"

On January 22, we released our first big report of the year, [The impact of new short-term rental regulations on New York City](/publication/impact-of-new-regulations/). This was a detailed examination of the state of the STR market in NYC, and scenario modelling 
...
The fact sheet is [available for download](/publication/strs-in-los-angeles) as a PDF; below I summarize the findings.
...
![upgo_summer](featured.jpg)
<p style="font-size:10pt; font-style:italic">Most of the UPGo summer team. Back row, from left: Nat Pace, Amy Bolt, Robin Basalaev-Binder, David Wachsmuth, Bowen Zhang. Front row: Charlotte Belot, Danielle Kerrigan, Danielle Girard, Lou Seltz, Cayce McClenen. Mikael Brunila was out of town!</p>
<br>
...
### Have Los Angeles STR listings been removed from the platforms?

The City’s regulations restrict STRs to a host’s principal residence, and limit listings to 120 nights of reservation per year unless the host receives a special “extended home-sharing option”. The City claims to be actively enforcing the rules as of November 1, although some lag time would be understandable. In fact, as shown above in Figure 1, there has been a substantial decline in the number of active STRs in Los Angeles, although this decline occurred before November 1. The decline was concentrated in the last ten days of October, when several thousand listings were removed in the space of a few days. Figure 5 shows listing takedowns each day, and shows the clearly unusual spike in late October. Given that the City of Los Angeles supplied Airbnb with a blacklist of rent controlled properties which are not eligible for short-term rentals, the most likely scenario is that the removed listings were these rent controlled properties. After the end of October, listing removals have returned to historic norms, which suggests that there have not been additional periods of major enforcement activity through the month of November.
...
'STRs in Los Angeles: Are the Nov. 2019 regulations being enforced?' is [publicly available for download today](/publication/strs-in-los-angeles).