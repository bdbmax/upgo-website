---
title: "Talking to Airbnb hosts: Why operate a commercial STR?"
date: '2019-11-25'
type: "post"
slug: str-hosts-part-1
categories: []
tags:
  - Short-term rentals
  - Montreal
  ...
  - Housing
subtitle: ''
summary: "Part 1 in a series discussing findings from interviews with STR hosts"
authors:
  - charlotte-belot
lastmod: '2019-11-25T07:00:06-04:00'
featured: yes
image:
  placement: 1
...
This summer, we initiated several lines of research collectively dubbed “the landlords projects” to answer some of these questions. In July, we undertook what we believe is the first attempt by academic researchers to interview STR hosts in a controlled and systematic way. We interviewed over 20 hosts in Montréal, with more ongoing. The goals of the interviews, which will inform research articles in progress, include:
...
### Opportunities to interact meaningfully with tourists
...
> Subject 1: You know, the core business model of Airbnb is to be very friendly with your guests, so we try to be involved as much as possible.
> Subject 2: And I think [...] something that I've never lost [...] is interaction, meeting people, and always having new tourists. And I think that it's very important. [...] It's being as involved as the guest wants you to be kind of thing. But also being there, whatever they need, and I think that's what--
> Subject 1: It's an interesting model, but it's also, you know, you have to have a love for hospitality.
...
### Filling a gap in the market not satisfied by hotels
...
### The ability to make more money than with traditional rentals  
...
> Subject: It's good for them, because they can see a lot more revenue. For sure.
> Researcher: So they would be making more by doing this than they would if they were just leasing to a tenant?
> Subject: Yeah.
...
### Frustration with long-term tenants

Montréal landlords who have converted their units to STRs consistently identified their frustrations with the supposed protections afforded to tenants as a motivation for undertaking the conversion. For example, when a unit is an STR, landlords have more access to the dwelling to clean and make repairs, and enjoy a lack of governmental control over the rates they charge and their ability to evict tenants they found problematic. 
...
While these opinions are no doubt sincerely held, it is also true that STRs are comparably prevalent in many large cities which lack Montréal's relative strong tenant rights. This suggests that tenant rights are unlikely to be a major cause of the growth of STRs. In future, it would be interesting to study in a systematic way how hosts’ motivations vary across municipal or provincial regulatory environments, and how these motivations relate to the supply of STRs.

<br>

### Trends and takeaways

The results of our interviews illustrate the complexities of the short-term rental landscape in Montréal. Other trends in the responses so far include the importance of cleaners and cleaning services (used by all but the smallest-scale operators), the recent proliferation of keyless locks (which facilitate check-ins), and the frequent use of full-time property managers or co-hosts. Additionally, almost all hosts cross-list their properties on multiple sites, such as booking.com, TripAdvisor, and Expedia, in addition to Airbnb. 

Underlying motivations to host STRs vary, but fall into a few categories: frustrated landlords looking to move away from traditional rentals, people with a background in and/or passion for the tourism industry, people with one or two listings using Airbnb to generate additional income--some of whom are affluent and looking for investment income, and some who use the income to be able to afford their basic living costs. In addition, sometimes hosts fit into more than one category.

A final point is that the motivations of individuals to list properties full-time on Airbnb is closely linked to their perceptions of the local market and regulatory landscape. In a post next week I will discuss some of the common perceptions and contradictions among Montréal’s commercial operators.