---
title: "Is dense urban living incompatible with COVID?"
...
This is the first part of our series, __*COVID-19: An overview of its impact on urban environments and socioeconomic consequences.*__ 

As the COVID-19 pandemic continues to circulate globally, with resurgences already happening in several cities and countries, it becomes increasingly imperative to contextualize it within our urban frameworks as we move forward into an unknown future. In North America alone, over 14 million confirmed cases have occured and nearly 380,000 deaths, with the vast majority of both in the United States (as of November 26, 2020). These numbers represent a conservative estimate, with likely many more cases and deaths. Urban areas have been hit the hardest, and even those with lesser outbreaks have already seen significant changes to work and social life, as well as to their urban landscapes and built forms. Over the next several weeks, we will be releasing findings from the research we completed this past summer on COVID and urban life. We aim to provide a broad look at current responses, tactics, and consequences of the pandemic. It is by no means a comprehensive review of all resources, but we examine certain key issues that pertain directly to urban landscapes and COVID-19, including its interaction with the built environment.

More than 90% of people inhabit the built environment today, which includes cars, roads, buildings, public transit and other human-built spaces (Dietz et al, 2020). Urban design can be used to promote health by advancing active transportation, providing access to clean air and shade, and fostering opportunities for social interaction and cohesion (Oppel, 2020). However, the possibility of the transmission of infectious diseases like COVID-19 via surfaces is a valid concern. While the role of fomites, which refers to both porous and nonporous surfaces or objects (Boone & Gerba, 2007) as transmission vectors is quite clear in some instances, such as not reusing needles or tongue depressors, it is seemingly not as clear when it comes to airborne viruses (Oppel, 2020). Despite some evidence that viruses can be recovered from such surfaces, this does not necessarily mean that surfaces are a significant cause of transmission. While this implies that physical distancing, good ventilation and good hygiene practices may be the centerpiece of preventative measures (Oppel, 2020), the question of surface transmission raises valid questions about the role of dense urban environments in the time of COVID. Over the next few weeks, we will unpack our findings on the impact of COVID-19 on various elements of the built environment, starting with density. 

The outbreak of COVID-19 in major cities across the world is challenging the way people perceive urban growth. “This is not life as usual. There is a density level in NYC that is destructive. It has to stop, and it has to stop now. NYC must develop an immediate plan to reduce density,” tweeted Governor Andrew Cuomo (2020) on March 22 while scrambling over one of the deadliest hubs of the outbreak. This attitude is backed up by an analysis that attributes higher death rates to denser population centres (Kolko, 2020). However, there is also a lot of evidence to the contrary. 

For one, many hyper-dense Asian cities such as Seoul, Singapore, Hong Kong, and Tokyo have all managed to contain the virus with early detection and strict quarantine enforcement (Patino, 2020). 

Secondly, an analysis by New York University’s Furman Center (2020) has found that while “COVID-19 is more prevalent in areas where more people reside in crowded units,” the “[o]verall population density is not associated with higher rates of COVID-19 cases.” Even when density is examined in its various aspects — number of inhabitants per area, number of units in a building, and number of residents per unit — the result remains the same: there is no significant correlation between density (or even overcrowding) and higher rates of COVID-19 (Fox, 2020). 
